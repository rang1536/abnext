		...
		<section class="content" style="font-size:13px;">
			<div class="container-fluid">
								...
								<table class="table table-bordered text-nowrap">
									<tbody>
										<tr>
											...
											<td style="width:30%;" class="txtc">
												<input type="hidden" id="procStat" value="${rceptInfo.procStat}"/>
												${rceptInfo.procStatNm }
											</td>
										</tr>
										<tr>
				...
				<div class="row">
 				...
 				<div style="z-index:9" id="finalResult">
					<div class="row">
						<div class="col-12">
							<div class="card card-primary card-outline">
								<!-- /.card-header -->
								...
								<div class="card-body">
									...
									<textarea class="form-control" id="finalMemo" disabled>${rceptInfo.finalMemo}</textarea>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-12" style="text-align:center">
						...
						<c:if test="${rceptInfo.procStat eq 'A001-05' }">
...
window.onload = function(){
	var procStat = $("#procStat").val();
	if(procStat == 'A001-04' || procStat == 'A001-05'){
		$("#inspList").find("tr").each(function(idx){
			var k = idx+1;
			var inspSecCd = $(this).find("[id^=inspSecondCd]").val();
			var inspNo = $(this).find("[id^=inspNo]").val();
