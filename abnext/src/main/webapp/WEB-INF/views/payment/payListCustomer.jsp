...
<script>
	...
	function search(){
		...
		if(userInfo != null) hospNo = userInfo.hospNo;
		...
		var sdata = {
	 	...
	 	$.ajax({
			...
			success:function(data){
				...
				var widthList = ['120','150','100','100','130','120','120','120','300'];
								...
								"itemTemplate" :
									function(value, item) {
										...
										if(value == '01') {
											...
											return '<p style="color:red;font-weight:bold;">'+$.gfn_setComma(item.price)+"(수납) </p>";
										}
									}
								}
					}else if(i == 5 || i == 6){
