	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1><b>지역별 혈청검사 통계</b></h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="index">Home</a></li>
							<li class="breadcrumb-item active"><b>지역별 혈청검사 통계</b></li>
						</ol>
					</div>
				</div>
			</div><!-- /.container-fluid -->
 			...
 			<div class="container-fluid">
				...
				<div class="card">
					<div class="card-header" style="background-color:#D4F4FA;color:#000000;">
						<h3 class="card-title"><b>지역별 혈청검사 통계</b></h3>
...
<script>
	...
	function setGrid(data){
		$("#jsGrid1").jsGrid({
	        ...
	        fields: [
	            ...
	            { name: "sample1", 	type: "number", width: 60, 	title:"WBC", 	align: "center"},
	            { name: "sample2", 	type: "number", width: 50, 	title:"mono/per", 		align: "center"},
	            { name: "sample3", 	type: "number", width: 60, 	title:"lympho/per", 	align: "center"},
	            { name: "sample4", 	type: "number", width: 80, 	title:"eosinophill/per",align: "center"},
	            { name: "sample5", 	type: "number", width: 70, 	title:"basophill/per", 	align: "center"},
	            { name: "sample6", 	type: "number", width: 50, 	title:"mono/no", 		align: "center"},
	            { name: "sample7", 	type: "number", width: 60, 	title:"lympho/no", 		align: "center"},
	            { name: "sample8", 	type: "number", width: 70, 	title:"basophill/no", 	align: "center"},
	            { name: "sample9", 	type: "number", width: 60, 	title:"RBC", 			align: "center"},
	            { name: "sample10", type: "number", width: 60, 	title:"Hct", 			align: "center"},
	            { name: "sample11", type: "number", width: 85, 	title:"Hemogolbin", 	align: "center"},
	            { name: "sample12", type: "number", width: 60, 	title:"MCV", 			align: "center"},
	            { name: "sample13", type: "number", width: 60, 	title:"MCH", 			align: "center"},
	            { name: "sample14", type: "number", width: 60, 	title:"MCHC", 			align: "center"},
	            { name: "sample15", type: "number", width: 70, 	title:"Platelet", 		align: "center"},
	            { name: "sample16", type: "number", width: 60, 	title:"PCT", 			align: "center"}
	        ]
	    });
	...
	function addSumRow(item) {
		...
		insert_item.sample15 = (item.sample15/chkRowCnt).toFixed(2);
		insert_item.sample16 = (item.sample16/chkRowCnt).toFixed(2);
		...
		update_item.sample15 = item.sample15;
		update_item.sample16 = item.sample16;
	...
	function updateSumRow(item, type) {
		...
		if(type == 'plus'){
			...
			update_item.sample15 = update_item.sample15 + item.sample15;
			update_item.sample16 = update_item.sample16 + item.sample16;
		...
		if(chkRowCnt == 0){
			...
			insert_item.sample15 = 0.00;
			insert_item.sample16 = 0.00;
		}else{
			...
			insert_item.sample15 = (update_item.sample15/chkRowCnt).toFixed(2);
			insert_item.sample16 = (update_item.sample16/chkRowCnt).toFixed(2);
		}
